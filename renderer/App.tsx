...
import AdvertisementDashboard from './page/ExternalDepartment/AdvertisementPartner/AdvertisementDashboard';
import AddAdvertisement from './page/ExternalDepartment/AdvertisementPartner/AddAdvertisement';
import AddNewSupplier from './page/ExternalDepartment/ExternalFoodDashboard/addNewSupplier';
import ViewAdvertisement from './page/ExternalDepartment/AdvertisementPartner/ViewAdvertisement';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/advertisement-dashboard' element={<AdvertisementDashboard />}/>
